...
function Roomlogin() {
  ...
  return (
    <div className='flex flex-col justify-center bg-gray-200 dark:bg-zinc-900 h-screen min-w-max'>
      <div className='bg-gray-300 dark:bg-zinc-800 h-[70vh] grid place-items-center'>
        <div className='flex w-full justify-start min-w-max'>
          <img src='./Images/learning.svg' alt='learning' className='m-6 w-md' />
          <div className='w-full m-6 min-w-max flex flex-col justify-center items-start'>
            <div className='container bg-gray-300 dark:bg-zinc-900 w-1/4 h-[36vh] p-7  flex flex-col shadow-2xl dark:shadow-none rounded-xl min-w-max'>
              ...
              <span className='text-gray-600 dark:text-zinc-500 py-1 text-sm self-end'>
                ...
                <button onClick={createNewRoom} className='text-gray-600 hover:text-gray-700 dark:text-zinc-400 dark:hover:text-zinc-600 pt-2 pl-1'>new room</button>
              </span>
            </div>
          </div>
        </div>
