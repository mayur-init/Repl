...
function Roomlogin() {
  ...
  return (
    <div className='bg-gray-300 dark:bg-zinc-900 h-screen grid place-items-center min-w-max p-4'>

      <div className='container bg-white dark:bg-zinc-800 w-1/4 p-7 flex flex-col shadow-2xl dark:shadow-none rounded-xl min-w-max'>
