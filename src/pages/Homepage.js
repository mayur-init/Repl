...
function Homepage() {
  ...
  return (
    <div className='bg-gray-200 dark:bg-zinc-900 h-screen py-4 no-scrollbar overflow-scroll'>
      ...
      <div className='grid place-content-center pt-8 bg-gray-300 dark:bg-zinc-800 w-auto flex-shrink'>
        <div className='flex'>
          ...
          <div className='flex flex-col justify-center h-auto items-center p-3 shrink'>
            <p className='md:text-3xl text-xl break-normal hidden md:contents text-zinc-500 m-2'>CodeSync is a online compiler with realtime collaboration feature.</p>
      ...
      <div className='flex justify-center h-[160vh] md:h-full bg-zinc-900 p-[4vh] md:p-[20vh] md:mt-[12vh] mt-[30vh]'>
