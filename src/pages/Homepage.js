...
function Homepage() {
  ...
  return (
    <div className='bg-gray-300 dark:bg-zinc-900 h-screen min-w-max p-6'>
      ...
      <div className='grid justify-center h-fit'>
        <div className='mt-[24vh]'>
          ...
          <Link to='/room' className='flex justify-center m-4'><button className='btn btn-primary border-2'>Rooms</button></Link>
        </div>
      </div>
    </div>
  )
