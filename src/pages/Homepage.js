    ...
    <div className='bg-gray-200 dark:bg-zinc-900 h-screen py-4'>
      ...
      <div className='grid place-content-center pt-8 bg-gray-300 dark:bg-zinc-800 w-auto flex-shrink'>
        <div className='flex'>
          ...
          <div className='flex flex-col justify-center h-auto items-center p-2 shrink'>
            <p className='md:text-3xl text-xl break-normal hidden md:contents text-zinc-500 m-2'>CodeSync is a realtime code collaboration tool for learners.</p>
